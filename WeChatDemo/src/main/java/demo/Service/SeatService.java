...
public interface SeatService {
    ...
    Map<String,Object> FindEveryEmptySeatOfFloorAndRoom(String floor, String room);//查询某个楼层全部的空座位,direction中0为南1为北
    Map<String,Object> FindEveryEmptySeatOfFloor(String floor);
    boolean SaveSeatOfUser(String uno,String floor, String room, String sno);
